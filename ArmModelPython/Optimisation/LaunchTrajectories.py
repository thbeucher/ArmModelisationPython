...
Module: LaunchTrajectories

Description: This class launch each trajectories of the experiment
'''
import numpy as np
#import time
...
class LaunchTrajectories:
    ...
    def LaunchTrajectoriesCMAES(self, theta):
        '''
    ...
    def LaunchTrajectoriesRBFN(self, theta):
        '''
